                                    ...
                                    <?php foreach ($images as $index => $image) { ?>
                                        <li data-bs-target="#vehicleCarousel" data-bs-slide-to="<?php echo $index; ?>"
                                            ...
                                            <?php if (!empty($image['src'])) { ?>
                                                <img src="data:image/jpeg;base64,<?php echo base64_encode($image['src']); ?>"
                                                    alt="<?php echo htmlentities($image['alt']); ?>" class="img-fluid">
                                            <?php } else { ?>
                                                <img src="img/placeholder.jpg" alt="<?php echo htmlentities($image['alt']); ?>"
                                                    class="img-fluid">
                                            <?php } ?>
                                        </li>
                                    <?php } ?>
                                ...
                                <div class="carousel-inner">
                                    <?php foreach ($images as $index => $image) { ?>
                                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                            <?php if (!empty($image['src'])) { ?>
                                                <img src="data:image/jpeg;base64,<?php echo base64_encode($image['src']); ?>"
                                                    class="d-block w-100 img-fluid" alt="<?php echo htmlentities($image['alt']); ?>">
                                            <?php } else { ?>
                                                <img src="img/placeholder.jpg" class="d-block w-100 img-fluid"
                                                    alt="<?php echo htmlentities($image['alt']); ?>">
                                            <?php } ?>
                                        </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="col-md-6 listing-detail">
                            <div class="card p-4">
                                <div class="listing_detail_head d-flex flex-wrap align-items-center mb-4">
                                    <div class="me-auto">
                                        <div class="page-pretitle text-muted"><?php echo htmlentities($result->BrandName); ?>
                                        </div>
                                        <h2 class="page-title"><?php echo htmlentities($result->VehiclesTitle); ?></h2>
                                    </div>
                                    <div class="price_info text-end">
                                        <p class="text-danger fs-3 mb-0">KES
                                            <?php echo number_format($result->PricePerDay, 2); ?>
                                        </p>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-4 text-center text-danger">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                <path
                                                    d="M5 11a2 2 0 0 1 2 2v2h10v-2a2 2 0 1 1 4 0v4a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-4a2 2 0 1 1 2 -2z" />
                                                <path d="M5 11v-5a3 3 0 0 1 3 -3h8a3 3 0 0 1 3 3v5" />
                                                <path d="M6 19v2" />
                                                <path d="M18 19v2" />
                                            </svg>
                                            <h5 class="mt-2">
                                                <?php echo str_pad($result->SeatingCapacity, 2, '0', STR_PAD_LEFT); ?>
                                            </h5>
                                ...
                                <div class="listing_more_info">
                                    <ul class="nav nav-tabs border-0 mb-3" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#vehicle-overview" role="tab"
                                                data-bs-toggle="tab">Vehicle Overview</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#accessories" role="tab"
                                ...
                                <div class="sidebar_widget">
                                    ...
                                    <form method="post" onsubmit="return validateDates()">
                                        ...
                                        <?php if (isset($_SESSION['login']) && !empty($_SESSION['login'])) { ?>
                                            <button type="submit" name="submit" class="btn btn-danger w-100">Book Now</button>
                                        <?php } else { ?>
                                            <a href="#loginform" class="btn w-100" data-bs-toggle="modal"
                                                data-bs-dismiss="modal">Login to Book</a>
                                        <?php } ?>
                                    </form>
                                </div>
                            </div>
                                                        ...
                                                        <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>">
                                                            <?php if (!empty($result->Vimage1)) { ?>
                                                                <img src="data:image/jpeg;base64,<?php echo base64_encode($result->Vimage1); ?>"
                                                                    class="img" alt="<?php echo htmlentities($result->VehiclesTitle); ?>">
                                                            <?php } else { ?>
                                                                <img src="img/placeholder.jpg" class="img" alt="No image available">
                                                            <?php } ?>
                                                        </a>
                                                    </div>
                                                    <div class="card-body">
                                                        <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"
                                                                class="text-white"><?php echo htmlentities($result->BrandName); ?>
                                                                <?php echo htmlentities($result->VehiclesTitle); ?></a></h5>
                                                        <p class="list-price text-danger mb-2">KES
                                                            <?php echo number_format($result->PricePerDay, 2); ?>
                                                        </p>
