											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) { ?>
													<tr>
														...
														<td><a href="edit-vehicle.php?id=<?php echo htmlentities($result->vid); ?>" class="text-primary"><?php echo htmlentities($result->BrandName); ?>, <?php echo htmlentities($result->VehiclesTitle); ?></a></td>
														...
														<td>
															<a href="booking-details.php?bid=<?php echo htmlentities($result->id); ?>" class="btn btn-sm btn-primary"><i class="ti ti-eye"></i> View</a>
														</td>
													</tr>
													<?php $cnt++;
												}
